...
const CardContent = ({
  ...
  <div style={{ textAlign: 'left', padding: '10px', marginTop: '10px' }}>
    <div style={{ marginTop: '10px', justifyContent: 'space-between' }}>
      <span style={{ fontSize: '16px', fontWeight: 'bold', color: '#FF6F61' }}>
        {type}
      </span>
      <span style={{ fontSize: '14px', color: '#888888', marginLeft: '20px' }}>
        {' '}
        {date}
      </span>
    </div>
    <div style={{ fontSize: '22px', color: '#000', marginTop: '10px' }}>
      {content}
    </div>
    <div
      style={{
    ...
    >
      <span style={{ fontSize: '14px', color: '#888888', marginRight: '20px' }}>
        좋아요 {likes}
      </span>
            ...
            >
              ...
              >
                ...
                <div
                  style={{
                    display: 'grid',
                    gridTemplateColumns: '150px auto auto auto',
                    alignItems: 'center',
                    width: '100%',
                    gap: '10px',
                  }}
